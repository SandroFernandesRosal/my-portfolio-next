  ...
  return (
    ...
    >
      {skillsData.map((skill: SkilsProps) => (
        <div
          key={skill.id}
          className="p-2  flex flex-col items-center text-zinc-400 bg-transparent dark:text-black  justify-center text-center h-[170px] justify-items-center content-center rounded-md  my-2"
        >
          {skill.name}
