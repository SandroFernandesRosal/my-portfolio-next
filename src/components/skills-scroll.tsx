  ...
  return (
    ...
    >
      {skillsData.map((skill: SkilsProps) => (
        <div
          key={skill.id}
          className="p-2  flex flex-col items-center text-primary justify-center text-center w-[170px] h-[170px] justify-items-center content-center rounded-md  my-2"
        >
          {skill.name}
          ...
          {skill.icon === 'Zustand' && (
            <RiBearSmileLine className="text-8xl " />
          )}
          {skill.icon === 'Angular' && (
            <RiAngularjsLine className="text-8xl " />
          )}
