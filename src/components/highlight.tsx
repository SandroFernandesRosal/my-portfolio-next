  ...
  return (
    <section className="flex flex-col relative">
      <section className="flex flex-wrap mb-24  bg-[url(../assets/bgtopo-dark3.png)] dark:bg-[url(../assets/bgtopo-light3.png)]  bg-cover items-center pt-5  justify-center md:justify-around   bg-bglightsecundary dark:bg-bgdarksecundary  dark:shadow-none dark:border-b-[1px] dark:border-none">
        ...
        <div className="flex w-full  bg-[url(../assets/bg-fotolight.png)] mt-5  ms:mt-0 dark:bg-[url(../assets/bg-fotoodark.png)] bg-cover md:bg-none dark:md:bg-none h-[315px] relative bottom-10 md:bottom-0 z-20  md:mb-[110px]  md:dark:shadow-shadowdark md:shadow-shadowlight md:flex items-end md:h-[270px] md:w-[270px] lg:h-[400px] lg:w-[400px]  justify-center md:rounded-perfil md:border-2px border-green md:dark:bg-bgdarksecundary overflow-hidden md:mt-5 ">
          <Image
            src={fotoPerfil}
            height={400}
            width={400}
