    ...
    <>
      ...
      <ul className="relative  mx-10  w-[85%] overflow-visible border-l border-zinc-700 dark:border-zinc-700 md:w-[45%] mb-20 ">
        ...
        <li className="ml-6 mb-5">
          ...
          <p className="overflow-hidden text-base font-normal text-gray-500 dark:text-gray-400">
            Introdução a programação estruturada em C, Modelagem de sistemas com
        ...
        <li className="ml-6 mb-5">
          ...
          <p className="overflow-hidden text-base font-normal text-gray-500 dark:text-gray-400">
            Desenvolvimento de uma aplicação back-end em Node.js, aplicação dos
            conceitos de API REST, utilizando TypeScript, Fastify como
            framework, integração do DrizzleORM + PostgreSQL, Docker e Zod para
            validação de dados. Desenvolvimento de uma aplicação front-end em
            ReactJS, aplicação dos conceitos de Propriedades, Estados e
            Componentes, tipagem com Typescript, tooling com Vite, interface
            responsiva com TailwindCSS, consumo de API Node.js, gerenciamento de
