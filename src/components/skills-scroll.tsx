  ...
  return (
    ...
    >
      {skillsData.map((skill: SkilsProps) => (
        <div
          key={skill.id}
          className="p-2 flex flex-col items-center dark:text-zinc-700 text-zinc-500  justify-items-center justify-center text-center w-[170px] h-[170px] rounded-md my-2"
        >
          {skill.name}
