...
export default function Contato() {
  ...
  return (
    <section id="contato" className="flex flex-col justify-center items-center  py-5  pb-40 dark:bg-[url(../assets/bg-darksecondary2.webp)] bg-[url(../assets/bg-lightsecondary2.webp)]   bg-bottom bg-repeat-x px-5 relative pt-[68px] -mt-[68px]">
