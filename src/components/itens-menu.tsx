...
export default function ItensMenu({ menu, handleMenu }: MenuProps) {
  return (
    <ul
      className={`w-full md:divide-x md:dark:divide-textdark md:divide-textlight md:w-auto text-2xl md:text-xl md:text-md ${!menu ? 'hidden' : 'flex flex-col'} md:flex md:items-center`}
    >
