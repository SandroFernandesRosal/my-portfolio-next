...
export default async function ProjectsPage() {
  ...
  return (
    <section className="lg:px-10  flex flex-col items-center dark:bg-bgdarksecundary bg-bglightsecundary  pb-40 dark:bg-[url(../assets/bg-dark2.png)] bg-[url(../assets/bg-light2.png)]  w-full bg-bottom bg-repeat-x">
