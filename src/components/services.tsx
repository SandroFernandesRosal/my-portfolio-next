...
export default function Services() {
  ...
  return (
    <section className="z-10 px-5 flex flex-col items-center dark:bg-bgdarksecondary bg-bglightsecondary pb-40 bg-[url(../assets/bg-light2.webp)] dark:bg-[url(../assets/bg-dark2.webp)] w-full bg-bottom bg-repeat-x">
      ...
      <div
        className="grid w-full md:grid-cols-3 md:grid-rows-2 gap-4 justify-center lg:w-[70vw]"
        ref={el}
      >
        {servicesData.map((service: ServicesProps, index) => {
          ...
          return (
            <div
              ...
              } w-full md:h-auto flex-col items-center text-center border-[1px] dark:border-zinc-700 border-transparent rounded-lg hover:border-primary dark:hover:border-primary border-zinc-400 bg-bglightsecondary dark:bg-bgdarksecondary hover:shadow-lg transition-all duration-300`}
            >
